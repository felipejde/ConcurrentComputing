...
public class Fumador extends Thread {
	...
	public synchronized void signal(Semaforo semaforo) {
		if (!semaforo.cola.isEmpty()) {
			...
			//System.out.println("Nombre: " + semaforo.cola.peek().getClass().getName().equals("Agente"));
			
			if (semaforo.cola.peek().getClass().getName() == "Agente") {
	...
	public void run() {
		while (Agente.iterador > 0) {
			...
			//System.out.println("Itrador: " + Agente.iterador);
		}
		System.exit(0);
	}
}
